...
const SignUp: React.FC = () => {
   ...
   const handleSubmit = async (event: React.FormEvent) => {
     ...
     try {
       // call api login https://report-work.onrender.com/login
        const response = await fetch('https://report-work.onrender.com/login', {
          method: 'POST',
          headers: {
      ...
      <div className="flex items-center justify-center min-h-screen bg-gray-100">
        <div className="relative flex flex-col m-6 space-y-8 bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0">
          ...
          <div className="relative">
            <img
              src="https://product.hstatic.net/200000857061/product/ckd_retino_collagen_small_molecule_300_guasha_neck_cream_packshot__1__0e5bd96262764806a4c23300eb1f5f37_1024x1024.jpg"
              alt="img"
